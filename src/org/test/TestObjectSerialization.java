...
public class TestObjectSerialization {
	...
	{	
		final String EXPECTED_OUT = StringXmlOutputter.formatXmlString(
				"<serialized>\r\n"
				+ "<object class=\"org.main.objects.Point\" id=\"0\">\r\n"
				+ "<field name=\"x\" declaringclass=\"org.main.objects.Point\">\r\n"
				+ "<value>10.0</value>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"y\" declaringclass=\"org.main.objects.Point\">\r\n"
				+ "<value>10.0</value>\r\n"
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "</serialized>"
	...
	public void testLineSerialization()
	{
		final String EXPECTED_OUT = StringXmlOutputter.formatXmlString(
				"<serialized>\r\n"
				+ "<object class=\"org.main.objects.Line\" id=\"0\">\r\n"
				+ "<field name=\"startPoint\" declaringclass=\"org.main.objects.Line\">\r\n"
				+ "<reference>1</reference>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"endPoint\" declaringclass=\"org.main.objects.Line\">\r\n"
				+ "<reference>2</reference>\r\n"
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "<object class=\"org.main.objects.Point\" id=\"1\">\r\n"
				+ "<field name=\"x\" declaringclass=\"org.main.objects.Point\">\r\n"
				+ "<value>10.0</value>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"y\" declaringclass=\"org.main.objects.Point\">\r\n"
				...
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "<object class=\"org.main.objects.Point\" id=\"2\">\r\n"
				+ "<field name=\"x\" declaringclass=\"org.main.objects.Point\">\r\n"
				+ "<value>-10.0</value>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"y\" declaringclass=\"org.main.objects.Point\">\r\n"
	...
	public void testPolygonSerialization()
	{
		final String EXPECTED_OUT = StringXmlOutputter.formatXmlString(
				"<serialized>\r\n"
				+ "<object class=\"org.main.objects.Polygon\" id=\"0\">\r\n"
				+ "<field name=\"numberOfSides\" declaringclass=\"org.main.objects.Polygon\">\r\n"
				+ "<value>4</value>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"vertices\" declaringclass=\"org.main.objects.Polygon\">\r\n"
				+ "<reference>1</reference>\r\n"
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "<object class=\"[Lorg.main.objects.Point;\" id=\"1\" length=\"4\">\r\n"
				+ "<reference>2</reference>\r\n"
				...
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "<object class=\"org.main.objects.Point\" id=\"3\">\r\n"
				+ "<field name=\"x\" declaringclass=\"org.main.objects.Point\">\r\n"
				+ "<value>0.0</value>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"y\" declaringclass=\"org.main.objects.Point\">\r\n"
				...
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "<object class=\"org.main.objects.Point\" id=\"4\">\r\n"
				+ "<field name=\"x\" declaringclass=\"org.main.objects.Point\">\r\n"
				+ "<value>5.0</value>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"y\" declaringclass=\"org.main.objects.Point\">\r\n"
				...
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "<object class=\"org.main.objects.Point\" id=\"5\">\r\n"
				+ "<field name=\"x\" declaringclass=\"org.main.objects.Point\">\r\n"
				+ "<value>0.0</value>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"y\" declaringclass=\"org.main.objects.Point\">\r\n"
	...
	public void testPolynomialSerialization()
	{
		final String EXPECTED_OUT = StringXmlOutputter.formatXmlString(
				"<serialized>\r\n"
				+ "<object class=\"org.main.objects.Polynomial\" id=\"0\">\r\n"
				+ "<field name=\"degree\" declaringclass=\"org.main.objects.Polynomial\">\r\n"
				+ "<value>2</value>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"roots\" declaringclass=\"org.main.objects.Polynomial\">\r\n"
				+ "<reference>1</reference>\r\n"
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "<object class=\"[F\" id=\"1\" length=\"2\">\r\n"
				+ "<value>1.0</value>\r\n"
				+ "<value>-3.0</value>\r\n"
				+ "</object>\r\n"
				+ "</serialized>"
	...
	public void testEmptyCartesianPlotSerialization()
	{
		final String EXPECTED_OUT = StringXmlOutputter.formatXmlString(
				"<serialized>\r\n"
				+ "<object class=\"org.main.objects.CartesianPlot\" id=\"0\">\r\n"
				+ "<field name=\"objects\" declaringclass=\"org.main.objects.CartesianPlot\">\r\n"
				+ "<reference>1</reference>\r\n"
				+ "</field>\r\n"
				+ "</object>\r\n"
	...
	public void testCartesianPlotSerialization()
	{
		final String EXPECTED_OUT = StringXmlOutputter.formatXmlString(
				...
				+ "</field>\r\n"
				+ "</object>\r\n"
				+ "<object class=\"org.main.objects.Line\" id=\"3\">\r\n"
				+ "<field name=\"startPoint\" declaringclass=\"org.main.objects.Line\">\r\n"
				+ "<reference>2</reference>\r\n"
				+ "</field>\r\n"
				+ "<field name=\"endPoint\" declaringclass=\"org.main.objects.Line\">\r\n"
